...
/**
 * Demo-aanmelden. Er is nog geen echte authenticatie: je kiest een account uit de
 * (fictieve) gebruikerslijst. Optioneel controleren we het fictieve wachtwoord.
 * Zonder aanmelding werk je als beheerder (volledige toegang); meld je aan als mentor
 * of leerling om hun weergave te zien.
 */
